...
if("TRUE" STREQUAL "TRUE")
  set(launcher_SOURCE_PREFIX /home/austin/combot/src/launcher)
  set(launcher_DEVEL_PREFIX /home/austin/combot/devel)
  set(launcher_INSTALL_PREFIX "")
  set(launcher_PREFIX ${launcher_DEVEL_PREFIX})
else()
  set(launcher_SOURCE_PREFIX "")
  set(launcher_DEVEL_PREFIX "")
  set(launcher_INSTALL_PREFIX /home/austin/combot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'austin <austin@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/austin/combot/src/launcher/${idir}'.  Ask the maintainer 'austin <austin@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/austin/combot/devel/lib;/home/austin/combot/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${launcher_dep}_FOUND)
      find_package(${launcher_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${launcher_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
